...
export const getProducts = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    sendError(res, 'Failed to retrieve products', error instanceof Error ? error.message : 'Unknown error', 500);
  }
};
...
export const getProductById = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    sendError(res, 'Failed to retrieve product', error instanceof Error ? error.message : 'Unknown error', 500);
  }
};
...
export const createProduct = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const product = new Product({
      ...
      brand,
      tags: tags || [],
      skus: [], // SKUs will be added separately
      basePrice,
      images: images || [],
      features: features || [],
      materials: materials || [],
    ...
    sendError(res, 'Failed to create product', error instanceof Error ? error.message : 'Unknown error', 500);
  }
};
...
export const updateProduct = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    sendError(res, 'Failed to update product', error instanceof Error ? error.message : 'Unknown error', 500);
  }
};
...
export const deleteProduct = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    sendError(res, 'Failed to delete product', error instanceof Error ? error.message : 'Unknown error', 500);
  }
};

// Add SKU to product
export const addProductSKU = async (req: Request, res: Response): Promise<void> => {
  try {
    const errors = validationResult(req);
    if (!errors.isEmpty()) {
      sendError(res, 'Validation failed', undefined, 400, errors.array());
    ...
    const { id } = req.params;
    const { size, color, stock, price, compareAtPrice, weight, images } = req.body;
    ...
    if (existingSKU) {
      sendError(res, 'SKU already exists for this size and color combination', undefined, 409);
      return;
    }
    ...
    sendError(res, 'Failed to add SKU', error instanceof Error ? error.message : 'Unknown error', 500);
  }
};

// Update SKU
export const updateProductSKU = async (req: Request, res: Response): Promise<void> => {
  try {
    const errors = validationResult(req);
    if (!errors.isEmpty()) {
      sendError(res, 'Validation failed', undefined, 400, errors.array());
    ...
    const { size, color, stock, price, compareAtPrice, weight, images, isActive } = req.body;
    ...
    if (compareAtPrice !== undefined) product.skus[skuIndex].compareAtPrice = compareAtPrice;
    ...
    sendError(res, 'Failed to update SKU', error instanceof Error ? error.message : 'Unknown error', 500);
  }
};

// Delete SKU
export const deleteProductSKU = async (req: Request, res: Response): Promise<void> => {
  try {
    const { id, skuId } = req.params;
    ...
    sendError(res, 'Failed to delete SKU', error instanceof Error ? error.message : 'Unknown error', 500);
  }
};